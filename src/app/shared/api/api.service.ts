...
import { Article, ArticleFormat, Tag } from '../base/models'
import { of } from 'rxjs'
    ...
    return of<Article[]>([
      {
        ...
        tags: [ 1, 2, 3 ],
        commentable: false,
        content: `<h1>RxJS лучшие практики</h1>
...
`,
        ...
        viewsCount: 40,
        commentsCount: 2,
        excerpt: `<p>This is a normal paragraph (<code>p</code> element).
To add some length to it, let us mention that this page was
primarily written for testing the effect of <strong>user style sheets</strong>.
You can use it for various other purposes as well</p>`
      },
      {
        id: 2,
        publishDate: '2020-05-22T17:03:47.957Z',
        modifyDate: '2020-05-22T17:03:47.957Z',
        slug: 'angular-best-practices',
        title: 'Angular лучшие практики',
        author: 1,
        categories: [],
        tags: [ 4, 5, 6 ],
        commentable: true,
        content: `<h1>Angular лучшие практики</h1>
...
those elements for which it can make sense to write user style sheet rules,
in my opionion.</p>
<p>Клик правой кнопки мыши по результату и выберите “Reveal in Elements Panel”, чтобы найти элемент в DOM или “Scroll in to View”, чтобы перейти к этому элементу на странице.
Следующий пример, возвращает ссылку на выбранный элемент и выводит значение его src атрибута:</p>
<div>This is a <code>div</code> element. Authors may use such elements instead
of paragraph markup for various reasons. (End of <code>div</code>.)</div>
<blockquote><p>This is a block quotation containing a single
paragraph. Well, not quite, since this is not <em>really</em>
...
`,
  ...
  public getArticleBySlug(slug: string) {
    return this.getArticles().pipe(
      map((articles) => articles.find(d => d.slug === slug))
    )
  }
